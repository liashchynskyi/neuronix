    ...
    public JsonModelBuilder init (int iter, double lRate) {
        listBuilder = new NeuralNetConfiguration.Builder()
            ...
            .gradientNormalization(
                GradientNormalization.valueOf(this.model.getGradientNormalization()))
    ...
    public MultiLayerNetwork build () {
        ...
        for (Layer l : layers) {
            ...
            switch (type) {
                ...
                case "output": {
                    this.listBuilder.layer(l.getId(), new OutputLayer.Builder(
                        LossFunction.valueOf(l.getLoss().toUpperCase()))
                        .nOut(l.getOut())
                        .activation(Activation.fromString(l.getActivation().toUpperCase()))
                        .build());
                    break;
